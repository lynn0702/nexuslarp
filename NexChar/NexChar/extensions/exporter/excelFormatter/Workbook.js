...
Ext.define("Ext.ux.exporter.excelFormatter.Workbook", {
  ...
  constructor: function(config) {
    ...
    Ext.apply(this, config, {
       ...
       */
        title: 'Workbook',
            //NWMRuntimeVariables.excelSheetName,
  ...
  render: function() {
    ...
    var joinedSheets = this.joinedWorksheets;
    joinedSheets = joinedSheets.split("<a href=\"#\">").join("");
    joinedSheets = joinedSheets.split("</a>").join("");
    this.joinedWorksheets = joinedSheets;
  ...
  addTitleStyle: function() {
   ...
   addSearchCriteriaStyle: function() {
    this.addStyle({
      id: "searchCriteria",
      attributes: [
        {name: "Borders"},
